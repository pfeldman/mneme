...
|-----|---------|--------|--------------------|------------|-----------|----------|
| `cold` | 1 | 0.12+/-0.00 | 0.00+/-0.00 | 0.00 | 8.00+/-0.00 | 0.63 |
| `cold_readme` | 1 | 0.25+/-0.00 | 0.20+/-0.00 | 0.00 | 2.00+/-0.00 | 0.40 |
| `memory` | 1 | 0.75+/-0.00 | 0.80+/-0.00 | 1.00 | 4.00+/-0.00 | 0.29 |
...
| `false_positive_guardrail` | **FAIL** | fp_delta=2.000, sigma=0.000, memory_fp=4.000+/-0.000 |
| `false_pass_control` | PASS | false_pass_rate=0.000 |
| `stale_trap_recall` | PASS | stale_trap_recall=1.000 |
| `off_path_fraction` | **FAIL** | off_path_fraction_mean=0.290 |

## Verdict: **KILL**

Killed by: false_positive_guardrail, off_path_fraction
