...
def redact(value: str) -> str:
    ...
    Best-effort filter (errs toward over-redacting). Knowledge should describe
    invariants ("a session cookie is set"), never the secret itself
    ("cookie=abc123"); redaction here is a safety net behind that discipline.
